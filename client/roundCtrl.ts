...
export class RoundController extends GameController {
    ...
    profileid: string;
    level: number;
    whiteDrawback: string;
    blackDrawback: string;
    clockOn: boolean;
    ...
    constructor(el: HTMLElement, model: PyChessModel) {
        ...
        this.whiteDrawback = model["whiteDrawback"];
        this.blackDrawback = model["blackDrawback"];
        ...
        this.vplayer0 = patch(player0, player('player0', this.titles[0], this.players[0], this.ratings[0], this.level, p0drawback));
        this.vplayer1 = patch(player1, player('player1', this.titles[1], this.players[1], this.ratings[1], this.level, p1drawback));
