...
function initModel(el: HTMLElement) {
    ...
    return {
        ...
        whiteDrawback : el.getAttribute("data-wdrawback") ?? "",
        blackDrawback : el.getAttribute("data-bdrawback") ?? "",

        whiteDrawbackDescription : el.getAttribute("data-wdrawbackdescription") ?? "",
        blackDrawbackDescription : el.getAttribute("data-bdrawbackdescription") ?? "",
        ...
        fen : el.getAttribute("data-fen") ?? "uz7PU/jz7PJ/rz7PR/zz7PP/lzz5PPL/sz7PS/rz7PR/jz7PJ/uz7PU w - - 0 1",
