...
# BOT_TOKENS = json.loads(os.getenv("BOT_TOKENS", "{\"Botmaster\": \"pv-903xaJz53453Hhyzx\", \"BoardBoat\": \"pv-jz9z4lacjr599xX\"}"))
BOT_TOKENS = json.loads(os.getenv("BOT_TOKENS", "{\"pv-903xaJz53453Hhyzx\": \"Botmaster\", \"pv-jz9z4lacjr599xX\": \"BoardBoat\"}"))
FISHNET_KEYS = json.loads(os.getenv("FISHNET_KEYS", "{}"))

ADMINS = os.getenv("ADMINS", "imusing").split(",")
